...
const file_protos_workflow_node_proto_rawDesc = "" +
	...
	"\x0eupstream_nodes\x18\x04 \x03(\v2\x18.aisociety.workflow.NodeR\rupstreamNodes\"M\n" +
...
var file_protos_workflow_node_proto_depIdxs = []int32{
	...
	6,  // 24: aisociety.workflow.ExecuteNodeResponse.status:type_name -> aisociety.workflow.NodeStatus
	27, // 25: aisociety.workflow.ExecutionOptions.RetryOptions.retry_delay:type_name -> google.protobuf.Duration
	0,  // 26: aisociety.workflow.Task.Result.status:type_name -> aisociety.workflow.Status
	25, // 27: aisociety.workflow.Task.Result.artifacts:type_name -> aisociety.workflow.Task.Result.ArtifactsEntry
	0,  // 28: aisociety.workflow.NodeStatus.Update.status:type_name -> aisociety.workflow.Status
	28, // 29: aisociety.workflow.NodeStatus.Update.updated_millis:type_name -> google.protobuf.Timestamp
	8,  // 30: aisociety.workflow.WorkflowService.CreateWorkflow:input_type -> aisociety.workflow.CreateWorkflowRequest
	10, // 31: aisociety.workflow.WorkflowService.GetWorkflow:input_type -> aisociety.workflow.GetWorkflowRequest
	12, // 32: aisociety.workflow.WorkflowService.ListWorkflows:input_type -> aisociety.workflow.ListWorkflowsRequest
	14, // 33: aisociety.workflow.WorkflowService.UpdateWorkflow:input_type -> aisociety.workflow.UpdateWorkflowRequest
	16, // 34: aisociety.workflow.WorkflowService.GetNode:input_type -> aisociety.workflow.GetNodeRequest
	19, // 35: aisociety.workflow.WorkflowService.UpdateNode:input_type -> aisociety.workflow.UpdateNodeRequest
	21, // 36: aisociety.workflow.NodeService.ExecuteNode:input_type -> aisociety.workflow.ExecuteNodeRequest
	9,  // 37: aisociety.workflow.WorkflowService.CreateWorkflow:output_type -> aisociety.workflow.CreateWorkflowResponse
	11, // 38: aisociety.workflow.WorkflowService.GetWorkflow:output_type -> aisociety.workflow.GetWorkflowResponse
	13, // 39: aisociety.workflow.WorkflowService.ListWorkflows:output_type -> aisociety.workflow.ListWorkflowsResponse
	15, // 40: aisociety.workflow.WorkflowService.UpdateWorkflow:output_type -> aisociety.workflow.UpdateWorkflowResponse
	17, // 41: aisociety.workflow.WorkflowService.GetNode:output_type -> aisociety.workflow.GetNodeResponse
	20, // 42: aisociety.workflow.WorkflowService.UpdateNode:output_type -> aisociety.workflow.UpdateNodeResponse
	22, // 43: aisociety.workflow.NodeService.ExecuteNode:output_type -> aisociety.workflow.ExecuteNodeResponse
