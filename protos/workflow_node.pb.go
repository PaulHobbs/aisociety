...
type NodeStatus struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	State         string                 `protobuf:"bytes,1,opt,name=state,proto3" json:"state,omitempty"`                                 // e.g., "PENDING", "RUNNING", "COMPLETED", "FAILED"
	Message       string                 `protobuf:"bytes,2,opt,name=message,proto3" json:"message,omitempty"`                             // optional status message or error
	LastUpdated   int64                  `protobuf:"varint,3,opt,name=last_updated,json=lastUpdated,proto3" json:"last_updated,omitempty"` // timestamp (epoch millis)
	Progress      []*NodeStatus_Update   `protobuf:"bytes,4,rep,name=progress,proto3" json:"progress,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ExecuteNodeResponse) GetStatus() *NodeStatus {
	if x != nil {
		return x.Status
	}
	return nil
...
const file_protos_workflow_node_proto_rawDesc = "" +
	...
	"\flast_updated\x18\x03 \x01(\x03R\vlastUpdated\x12A\n" +
	"\bprogress\x18\x04 \x03(\v2%.aisociety.workflow.NodeStatus.UpdateR\bprogress\x1a\xaa\x01\n" +
	"\x06Update\x122\n" +
	...
	"\x13ExecuteNodeResponse\x126\n" +
	"\x06status\x18\x01 \x01(\v2\x1e.aisociety.workflow.NodeStatusR\x06status*|\n" +
	"\x06Status\x12\n" +
	"\n" +
	...
	"\vNodeService\x12^\n" +
	"\vExecuteNode\x12&.aisociety.workflow.ExecuteNodeRequest\x1a'.aisociety.workflow.ExecuteNodeResponseB!Z\x1fpaul.hobbs.page/aisociety/protob\x06proto3"
...
var file_protos_workflow_node_proto_depIdxs = []int32{
	...
	6,  // 22: aisociety.workflow.ExecuteNodeResponse.status:type_name -> aisociety.workflow.NodeStatus
	27, // 23: aisociety.workflow.ExecutionOptions.RetryOptions.retry_delay:type_name -> google.protobuf.Duration
	0,  // 24: aisociety.workflow.Task.Result.status:type_name -> aisociety.workflow.Status
	25, // 25: aisociety.workflow.Task.Result.artifacts:type_name -> aisociety.workflow.Task.Result.ArtifactsEntry
	0,  // 26: aisociety.workflow.NodeStatus.Update.status:type_name -> aisociety.workflow.Status
	28, // 27: aisociety.workflow.NodeStatus.Update.updated_millis:type_name -> google.protobuf.Timestamp
	8,  // 28: aisociety.workflow.WorkflowService.CreateWorkflow:input_type -> aisociety.workflow.CreateWorkflowRequest
	10, // 29: aisociety.workflow.WorkflowService.GetWorkflow:input_type -> aisociety.workflow.GetWorkflowRequest
	12, // 30: aisociety.workflow.WorkflowService.ListWorkflows:input_type -> aisociety.workflow.ListWorkflowsRequest
	14, // 31: aisociety.workflow.WorkflowService.UpdateWorkflow:input_type -> aisociety.workflow.UpdateWorkflowRequest
	16, // 32: aisociety.workflow.WorkflowService.GetNode:input_type -> aisociety.workflow.GetNodeRequest
	19, // 33: aisociety.workflow.WorkflowService.UpdateNode:input_type -> aisociety.workflow.UpdateNodeRequest
	21, // 34: aisociety.workflow.NodeService.ExecuteNode:input_type -> aisociety.workflow.ExecuteNodeRequest
	9,  // 35: aisociety.workflow.WorkflowService.CreateWorkflow:output_type -> aisociety.workflow.CreateWorkflowResponse
	11, // 36: aisociety.workflow.WorkflowService.GetWorkflow:output_type -> aisociety.workflow.GetWorkflowResponse
	13, // 37: aisociety.workflow.WorkflowService.ListWorkflows:output_type -> aisociety.workflow.ListWorkflowsResponse
	15, // 38: aisociety.workflow.WorkflowService.UpdateWorkflow:output_type -> aisociety.workflow.UpdateWorkflowResponse
	17, // 39: aisociety.workflow.WorkflowService.GetNode:output_type -> aisociety.workflow.GetNodeResponse
	20, // 40: aisociety.workflow.WorkflowService.UpdateNode:output_type -> aisociety.workflow.UpdateNodeResponse
	22, // 41: aisociety.workflow.NodeService.ExecuteNode:output_type -> aisociety.workflow.ExecuteNodeResponse
